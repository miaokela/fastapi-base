...
from app.views.user_views import AuthViewSet, UserViewSet, UserProfileViewSet
...
async def get_user_stats():
    """获取用户统计报告"""
    from app.utils.query_builder import query_examples
    
    try:
        stats = await query_examples()
        return {
            "success": True,
            "data": stats
        }
