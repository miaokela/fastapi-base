...
from app.utils.simple_query_builder import SimpleQueryBuilder, UserQueryBuilder, PostQueryBuilder
from tortoise import Tortoise
from tortoise.models import Model


# 为了保持兼容性，重新导出简化的查询构建器
ComplexQueryBuilder = SimpleQueryBuilder
...
class ComplexQueryBuilder:
    ...
    def build(self) -> str:
        """构建SQL查询语句"""
        # 如果还没有设置表名，先设置
        if self.table_name and not hasattr(self.query_builder, '_from_table'):
            self.from_table()
        return self.query_builder.build()
