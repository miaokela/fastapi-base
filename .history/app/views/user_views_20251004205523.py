...
# 注册认证路由
AuthViewSet.add_api_route("/auth/register", methods=["POST"], endpoint=AuthViewSet.register)
AuthViewSet.add_api_route("/auth/login", methods=["POST"], endpoint=AuthViewSet.login)
AuthViewSet.add_api_route("/auth/me", methods=["GET"], endpoint=AuthViewSet.get_me)
